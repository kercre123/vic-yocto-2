...
EXTRA_OECONF:append_class-nativesdk = " --with-confdir=${sysconfdir}"

DEPENDS += "util-linux"
LVM2_PACKAGECONFIG:append_class-target = " \
    udev \
"
...
RDEPENDS:${PN}:append_class-target = " libdevmapper"
RDEPENDS:${PN}:append_class-nativesdk = " libdevmapper"
