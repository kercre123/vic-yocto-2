...
EXTRA_OECONF:append_class-target = " --with-sanitized-headers=${STAGING_KERNEL_BUILDDIR}/usr/include"
EXTRA_OECONF:append_class-native = " --with-core-headers=${STAGING_INCDIR_NATIVE}"
EXTRA_OECONF:append_class-native = " --enable-selinux"
