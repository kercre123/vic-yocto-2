...
FILES:${PN}-dbg    = "${libdir}/.debug/libbinder.* ${bindir}/.debug/servicemanager ${bindir}/test_binder"
FILES:${PN}        = "${libdir}/libbinder.so.* ${libdir}/pkgconfig/* ${bindir}/servicemanager"
FILES:${PN}-dev    = "${libdir}/libbinder.so ${libdir}/libbinder.la ${includedir}"
FILES:${PN}-static = "${libdir}/libbinder.a"
